...
import ScholarApproval from "../../pages/Admin/ScholarApprovals";
import RegisterScholar from "../../pages/Auth/RegisterScholar";
  ...
  return (
    <Routes>
      <Route element={<Layout />}>
        ...
        <Route path="/dashboard/admin" element={<ScholarApproval />} />
        <Route path="/admin" element={<Login />} />
        <Route path="/register-scholar" element={<RegisterScholar />} />
