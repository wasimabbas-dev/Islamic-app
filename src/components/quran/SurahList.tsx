    ...
    <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
      {surahs.map((surah) => (
        <button
          ...
          className="group relative bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-4 text-left border border-transparent hover:border-violet-200 dark:hover:border-violet-700"
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 rounded-full bg-violet-100 dark:bg-violet-900/30 flex items-center justify-center shrink-0">
                <span className="text-violet-600 dark:text-violet-400 font-arabic text-lg">
                  {surah.number}
                </span>
              </div>
              <div>
